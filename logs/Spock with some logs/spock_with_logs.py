...
logger = logging.getLogger('Game logs')
...
class Main(Frame):
    ...
    def btn_click(self, choise):
        ...
        if choise == 0:
            logger.info('Выбран камень')
        elif choise == 1:
            logger.info('Выбраны ножницы')
        elif choise == 2:
            logger.info('Выбрана бумага')
        elif choise == 3:
            logger.info('Выбрана ящерица')
        elif choise == 4:
            logger.info('Выбран Спок')
        
        logger.info(f'Компьютер выбрал {list_1[comp_choise]}')
